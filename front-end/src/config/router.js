const LoginPage = require('@/module/page/login/Container');
const RegisterPage = require('@/module/page/register/Container');
const ForgotPasswordPage = require('@/module/page/forgot_password/Container');
const ResetPasswordPage = require('@/module/page/reset_password/Container');

const ProfileInfoPage = require('@/module/page/profile/info/Container');

// post
const PostListPage = require('@/module/page/post/list/Container');
const PostCreatePage = require('@/module/page/post/create/Container');
const PostEditPage = require('@/module/page/post/edit/Container');
const PostDetailPage = require('@/module/page/post/detail/Container');

const NotFound = require('@/module/page/error/NotFound');
